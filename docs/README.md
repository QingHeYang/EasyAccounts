...
| <p><img src="image/Feature/Feature-Board.png" alt=""></p><p>总览</p>            | <p><img src="image/Feature/Feature-Flow.png" alt=""></p><p>明细</p>              | <p><img src="image/Feature/Feature-Analysis-List.png" alt=""></p><p>统计</p>    | <p><img src="image/Feature/Feature-About.png" alt=""></p><p>设置</p>    |
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| <p><img src="image/Feature/Feature-Board-Accounts.png" alt=""></p><p>总览账户</p> | <p><img src="image/Feature/Feature-Flow-Add.png" alt=""></p><p>新增明细</p>        | <p><img src="image/Feature/Feature-Flow-Template.png" alt=""></p><p>筛选</p>    | <p><img src="image/Feature/Feature-Screen.png" alt=""></p><p>分类界面</p> |
| <p><img src="image/Feature/Feature-Type-List.png" alt=""></p><p>分类列表</p>      | <p><img src="image/Feature/Feature-Analysis-Type.png" alt=""></p><p>分类单项统计</p> | <p><img src="image/Feature/Feature-Analysis-Chart.png" alt=""></p><p>统计图表</p> | <p><img src="image/Feature/Feature-Login.png" alt=""></p><p>登录</p>    |

| <p><img src="image/Swagger_info.png" alt=""></p><p>Swagger 文档</p> | <p><img src="image/Nginx_info.png" alt=""></p><p>Nginx 文件下载</p> |
| ----------------------------------------------------------------- | --------------------------------------------------------------- |
| <p><img src="image/Email_info.png" alt=""></p><p>Email 推送</p>     | <p><img src="image/Excel_info.png" alt=""></p><p>Excel 生成</p>   |

### 项目功能导图

![](image/EasyAccountsFunction.png)
...
具体使用方法见：[WebHook使用说明](deploy/webhook.md)\
配置好发送邮件功能后，就可以在手机上接收excel以及SQL文件了，效果如下：\
![](image/Email_get.png) ![](image/Email_sql.png)
...
请阅读贡献指南：[贡献指南](develop/CONTRIBUTING.md)
...
| ![](image/WeChat.jpg) | ![](image/Ali_pay.jpg) |
| --------------------- | ---------------------- |
