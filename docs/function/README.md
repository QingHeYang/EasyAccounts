...
<table>
  <tr width="70%">
    <td>
      <img src="function/image/Feature/Feature-Board.png" width="100%" />
      <p align="center">总览</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Flow.png" width="100%" />
      <p align="center">明细</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Analysis-List.png" width="100%" />
      <p align="center">统计</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-About.png" width="100%" />
      <p align="center">设置</p>
    </td>
  </tr>
  <tr width="70%">
    <td>
      <img src="function/image/Feature/Feature-Board-Accounts.png" width="100%" />
      <p align="center">总览账户</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Flow-Add.png" width="100%" />
      <p align="center">新增明细</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Flow-Template.png" width="100%" />
      <p align="center">筛选</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Screen.png" width="100%" />
      <p align="center">分类界面</p>
    </td>
  </tr>
  <tr width="70%">
    <td>
      <img src="function/image/Feature/Feature-Type-List.png" width="100%" />
      <p align="center">分类列表</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Analysis-Type.png" width="100%" />
      <p align="center">分类单项统计</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Analysis-Chart.png" width="100%" />
      <p align="center">统计图表</p>
    </td>
    <td>
      <img src="function/image/Feature/Feature-Login.png" width="100%" />
      <p align="center">登录</p>
    </td>
  </tr>
...
<table>
  <tr width="80%">
    <td>
      <img src="function/image/Swagger_info.png" width="100%" />
      <p align="center">Swagger 文档</p>
    </td>
    <td>
      <img src="function/image/Nginx_info.png" width="100%" />
      <p align="center">Nginx 文件下载</p>
    </td>
  </tr>
   <tr width="70%">
    <td>
      <img src="function/image/Email_info.png" width="100%" />
      <p align="center">Email 推送</p>
    </td>
    <td>
      <img src="function/image/Excel_info.png" width="100%" />
...
### 项目功能导图  
<img src="function/image/EasyAccountsFunction.png" width="90%" />  
...
<img src="function/image/Email_get.png" width="45%" />
<img src="function/image/Email_sql.png" width="45%" />
  
### 其他功能  
1. Swagger接口文档，可以查看接口文档，支持自定义开发前端。  
<img src="function/image/Swagger.png" width="65%" />  
2. Nginx提供生成文件的下载服务，可以直接下载生成的文件  
<img src="function/image/Nginx.png" width="65%" />  
  
上述两个地址详见：[项目部署-项目访问](/deploy/deploy.md#项目访问)  
...
<table>
  <tr width="70%">
    <td>
    <img src="function/image/WeChat.jpg" width="70%" /> 
    </td>
    </td>
    <td><img src="function/image/Ali_pay.jpg" width="50%" />
    </td>
</tr>
</table>